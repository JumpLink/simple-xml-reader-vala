 ...
 */
public class Sxml.XmlStreamWriter {
	...
	/**
	 * Initializes a new instance of the XmlStreamWriter
	 * 
	 * @param write stream a StringBuilder
	 * @param xml_declaration specifies whether this file starts with an xml-declaration
	 */
	public XmlStreamWriter (owned StringBuilder builder, bool xml_declaration = true) {
	 ...
	 * @return this
	 */
	public XmlStreamWriter start_tag (string name, string[]? attributes=null) {
		indent++;
		check_column (name);
	 ...
	 * @return this
	 */
	public XmlStreamWriter simple_tag (string name, string[]? attributes=null) {
		indent++;
		check_column (name);
	 ...
	 * @return this
	 */
	public XmlStreamWriter end_tag (string name) {
	 ...
	 * @return this
	 */
	public XmlStreamWriter raw_text (string text) {
		do_write (text);
		last_was_tag = false;
		return this;
	}
	...
	builder.append("\n");
	builder.append(string.nfill (indent * 2, ' '));
